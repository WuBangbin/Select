...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    // UI references.
    private AutoCompleteTextView studentIdEdit;
    ...
    private static final String INFORMATION_PORTAL_LOGIN_URL = "http://my.tjut.edu.cn/userPasswordValidate.portal";      //信息门户请求网站
    private static final String INFORMATION_PORTAL_CAPTCHA_URL = "http://my.tjut.edu.cn/captchaGenerate.portal";      //信息门户验证码

    private static final int  LOAD_CAPTCHA_OK = 1;      //下载验证码成功
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        studentIdEdit = (AutoCompleteTextView) findViewById(R.id.studentId);
    ...
    private boolean mayRequestContacts() {
        ...
        if (shouldShowRequestPermissionRationale(READ_CONTACTS)) {
            Snackbar.make(studentIdEdit, R.string.permission_rationale, Snackbar.LENGTH_INDEFINITE)
    ...
    private void attemptLogin() {
        ...
        if (TextUtils.isEmpty(studentId)) {
            studentIdEdit.setError(getString(R.string.error_field_required));
            focusView = studentIdEdit;
            cancel = true;
        } else if (!isStudentIdValid(studentId)) {
            studentIdEdit.setError(getString(R.string.error_invalid_student_id));
            focusView = studentIdEdit;
            cancel = true;
        }
    ...
    private void addEmailsToAutoComplete(List<String> emailAddressCollection) {
        ...
        studentIdEdit.setAdapter(adapter);
    }
    ...
    public void initListener(){
        captchaImgView.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                getCaptchaImg();
            }
